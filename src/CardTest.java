...
public class CardTest {
    public static void main(String[] args) {
        ...
        System.out.println("Before generating ability: " + powerCard);  // Should print default Suit: Special, Rank: None, Value: 0
        ...
        System.out.println("After generating ability: " + powerCard);  // Should print Suit: Risk, Rank: DoubleDmg, Value: 0
